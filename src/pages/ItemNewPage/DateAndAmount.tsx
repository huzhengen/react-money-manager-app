...
export const DateAndAmount: React.FC<Props> = (props) => {
  ...
  const { popup, toggle } = usePopup(true, <Datepicker onChange={() => { }} />)
  return (
    <>
      <div className={className}>
        ...
        <div py-1px grid
          ...
          <button row-start-1 col-start-4 row-end-3 col-end-5>Empty</button>
          <button row-start-3 col-start-4 row-end-5 col-end-5>Submit</button>
        </div>
      </div>
      {popup}
    </>
